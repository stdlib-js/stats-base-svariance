...
/**
* Interface describing `svariance`.
*/
interface Routine {
	/**
	...
	*/
	...
	/**
	* Computes the variance of a single-precision floating-point strided array using alternative indexing semantics.
	*
	* @param N - number of indexed elements
	* @param correction - degrees of freedom adjustment
	* @param x - input array
